  ...
  return (
    <>
      ...
      <header className="signup-header">
        <div></div>
        <div className="finish-signup">Edit Venues</div>
        <div></div>
      </header>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='listing-specs'>
            ...
            <div className="input-div">
              ...
              <span className="bedrooms-floating-label">Rooms</span>
            </div>
            ...
            <div className="input-div">
              ...
              <span className="beds-floating-label">Overnight</span>
            </div>
          ...
          <div className='coord-price'>
            ...
            <div className='price-input-div'>
              <input 
                ...
                placeholder='Price'
                required/>
                <span className="price-floating-label">KSH</span>
